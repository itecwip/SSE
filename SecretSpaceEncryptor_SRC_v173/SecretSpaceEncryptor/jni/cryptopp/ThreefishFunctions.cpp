...
void Threefish_256::Enc::ThreefishEncrypt256(word64* input, word64* output) const
{

    word64 b0 = input[0], b1 = input[1],
      b2 = input[2], b3 = input[3];
    word64 k0 = m_key[0], k1 = m_key[1],
      k2 = m_key[2], k3 = m_key[3],
      k4 = m_key[4];
    word64 t0 = m_tweak[0], t1 = m_tweak[1],
      t2 = m_tweak[2];
...
void Threefish_256::Dec::ThreefishDecrypt256(word64* input, word64* output) const
{
    word64 b0 = input[0], b1 = input[1],
      b2 = input[2], b3 = input[3];
    word64 k0 = m_key[0], k1 = m_key[1],
...
void Threefish_512::Enc::ThreefishEncrypt512(word64* input, word64* output) const
{
    ...
    word64 k0 = m_key[0], k1 = m_key[1],
      k2 = m_key[2], k3 = m_key[3],
      k4 = m_key[4], k5 = m_key[5],
      k6 = m_key[6], k7 = m_key[7],
      k8 = m_key[8];
    word64 t0 = m_tweak[0], t1 = m_tweak[1],
      t2 = m_tweak[2];
...
void Threefish_512::Dec::ThreefishDecrypt512(word64* input, word64* output) const
{
...
void Threefish_1024::Enc::ThreefishEncrypt1024(word64* input, word64* output) const
{
    ...
    word64 k0 = m_key[0], k1 = m_key[1],
      ...
      k4 = m_key[4], k5 = m_key[5],
      k6 = m_key[6], k7 = m_key[7],
      k8 = m_key[8], k9 = m_key[9],
      k10 = m_key[10], k11 = m_key[11],
      k12 = m_key[12], k13 = m_key[13],
      k14 = m_key[14], k15 = m_key[15],
      k16 = m_key[16];
    word64 t0 = m_tweak[0], t1 = m_tweak[1],
      t2 = m_tweak[2];
...
void Threefish_1024::Dec::ThreefishDecrypt1024(word64* input, word64* output) const
{
