...
public class HuffmanDecode {
	...
	private int RI;
	private static byte[][] deZZ = { { 0, 0 }, { 0, 1 }, { 1, 0 }, { 2, 0 },
			{ 1, 1 }, { 0, 2 }, { 0, 3 }, { 1, 2 }, { 2, 1 }, { 3, 0 },
			{ 4, 0 }, { 3, 1 }, { 2, 2 }, { 1, 3 }, { 0, 4 }, { 0, 5 },
			{ 1, 4 }, { 2, 3 }, { 3, 2 }, { 4, 1 }, { 5, 0 }, { 6, 0 },
			{ 5, 1 }, { 4, 2 }, { 3, 3 }, { 2, 4 }, { 1, 5 }, { 0, 6 },
			{ 0, 7 }, { 1, 6 }, { 2, 5 }, { 3, 4 }, { 4, 3 }, { 5, 2 },
			{ 6, 1 }, { 7, 0 }, { 7, 1 }, { 6, 2 }, { 5, 3 }, { 4, 4 },
			{ 3, 5 }, { 2, 6 }, { 1, 7 }, { 2, 7 }, { 3, 6 }, { 4, 5 },
			{ 5, 4 }, { 6, 3 }, { 7, 2 }, { 7, 3 }, { 6, 4 }, { 5, 5 },
			{ 4, 6 }, { 3, 7 }, { 4, 7 }, { 5, 6 }, { 6, 5 }, { 7, 4 },
			{ 7, 5 }, { 6, 6 }, { 5, 7 }, { 6, 7 }, { 7, 6 }, { 7, 7 } };
	...
	public CoeffWrapper decode() {
		...
		boolean buff[] = new boolean[2 * 8 * 8 * getBlockCount()];
		boolean nulls[] = new boolean[buff.length];
				...
				for (cnt = 0; cnt < H[nComponent] * V[nComponent]; cnt++) {
					...
					for (lp = 0; lp < 64; lp++) {
						...
						if (current == 0)
							...
							buff[pos] = (current & 1) == 1 ? true : false;
						else
							buff[pos] = 1 - (current & 1) == 1 ? true : false;
						++pos;
					}
				}
			}
		...
		CoeffWrapper coeff = new CoeffWrapper(buff, nulls, pos);
