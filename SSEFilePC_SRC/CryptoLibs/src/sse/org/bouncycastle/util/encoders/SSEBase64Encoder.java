 ...
 * 
 * Convert binary data to and from Base64 encoding.  This is identical to
 * Base64 encoding, except that the padding character is "." and the other 
 * non-alphanumeric characters are ")" and "]" instead of "+" and "/".
 */
public class SSEBase64Encoder
    implements Encoder
{
    ...
    protected final static byte    padding = (byte)'.';
